...
interface GameData {
  client: {
    ...
    projectiles: { arrows: number; rockets: number };
    inventory: {
...
function UI() {
  const [player, setPlayer] = useState<{
    ...
    weaponry: [],
    boost: 0,
    shield: { amount: 0, isActive: false, isCharging: false },
    overload: 0,
    isOverloaded: false,
    inventory: {
      itemSlots: [],
    ...
    projectiles: { arrows: 0, rockets: 0 },
    bowCustomization: {
  ...
  useEffect(() => {
    ...
    socket.on("Game State Update", (gameData: GameData) => {
      ...
      setPlayer({
        ...
        isOverloaded: client.isOverloaded,
      });
    });
  ...
  return (
    ...
    >
      <CenterStatus
        ...
        isOverloaded={player.isOverloaded}
      />
      ...
      <div className={styles.ui}>
        ...
        <section className={styles.weaponstatus}>
          ...
          >
            ...
            <div>{player.projectiles.rockets}</div>
          </div>
